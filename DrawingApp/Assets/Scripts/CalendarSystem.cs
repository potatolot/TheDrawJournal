...
// Calendar system created using the help of this tutorial: https://www.youtube.com/watch?v=cMwCZhZnE4k
...
public class CalendarSystem : MonoBehaviour
{
    ...
    [SerializeField] private Canvas _noDataCanvas;
    ...
    public class Day
    {
        ...
        public void UpdateDay(int newDayNum)
        {
            ...
            if (dayColor == Color.white || dayColor == new Color(200f/225f, 121f/225f, 101f/225f))//Color.green)
            {
    ...
    void UpdateCalendar(int year, int month)
    {
        ...
        {
            days[(DateTime.Now.Day - 1) + startDay].UpdateColor(new Color(200f / 225f, 121f / 225f, 101f / 225f));
        }
    ...
    public void PickDate(Text day)
    {
        DateTime newDate = new DateTime(currDate.Year, currDate.Month, int.Parse(day.text));
        string dayPicked = "D" + newDate.Day.ToString() + newDate.Month.ToString() + newDate.Year.ToString();//day.text + MonthAndYear.text;
        Debug.Log(dayPicked);

        if(_sql.Tables.Contains(dayPicked))
        {
            _visualization.clickedDay = dayPicked;
        ...
        else
        {
            ...
            _noDataCanvas.gameObject.SetActive(true); //.gameObject.SetActive(true);
            this.gameObject.SetActive(false);
        }
    }
}